...
public class HybridDBStorage implements ScottyDBStorageInterface {
    ...
    public List<Workflow<?>> dequeue(final String ppoolId, final int max) throws Exception {
        ...
        logger.debug("dequeue({},{}) finished, returning {} elements in {} msec", toObjectArr(ppoolId, new Integer(max).toString(), new Integer(wfList.size()).toString()), (System.currentTimeMillis() - startTS));
        return wfList;
    }
    ...
    void _enqueue(String wfId, String ppoolId, int prio) {
        logger.trace("enqueue(wfId={}, ppoolId={}, prio={})",toObjectArr(wfId, ppoolId, new Integer(prio).toString()));
    ...
    private Object[] toObjectArr(String val1,String val2,String val3) {
	...
	@Override
	public List<Workflow<?>> queryAllActive(String className, int max) throws Exception {
